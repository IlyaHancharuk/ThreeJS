...
doorstep.position.set(0, 0, 2.08)

// Chimney
const chimney = new THREE.Mesh(
    // new THREE.BoxGeometry(0.5, 1, 0.5),
    new THREE.CylinderGeometry( 0.25, 0.25, 1, 4, 1, true ),
    wallsMaterial
)
chimney.rotation.y = PI * 0.25
chimney.position.set(-1, 3, 0)

house.add(walls, roof, door, doorstep, chimney)
...
for (let i = 0; i < 50; i++) {
    const angle = Math.random() * PI * 2 // Random angle
