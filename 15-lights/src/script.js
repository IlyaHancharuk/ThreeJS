...
gui.addColor(hemisphereLight, 'color').name('hemisphereLightSkyColor')
gui.addColor(hemisphereLight, 'groundColor').name('hemisphereLightGroundColor')

const rectAreaLight = new THREE.RectAreaLight(0x4e00ff, 2, 1, 1)
rectAreaLight.position.set(- 1.5, 0, 1.5)
rectAreaLight.lookAt(new THREE.Vector3())
scene.add(rectAreaLight)
gui.add(rectAreaLight, 'intensity').min(0).max(20).step(0.01).name('rectAreaLightIntensity')
gui.addColor(rectAreaLight, 'color').name('rectAreaLightColor')
...
gui.add(spotLight, 'intensity').min(0).max(1).step(0.01).name('spotLightIntensity')
gui.addColor(spotLight, 'color').name('spotLightColor')
gui.add(spotLight.target.position, 'x').min(-2).max(2).step(0.01).name('spotLightTargetPosX')
